...
<body>
    <div id="wrapper">
        ...
        <div id="main">
          <form action="recommend" method="GET" class="form" name="pageForm">
            ...
            <div class="row">
                    <div class="form-item" >
                     {{ $movies->links() }}
                    <input method="GET" type="submit" id="continue-onward"  class="button red-primary justify-content" value="Recommend me a movie!" />
                    </div>
            </div>
