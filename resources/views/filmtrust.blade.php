...
<body>
    <div id="wrapper">
        ...
        <div id="main">
            <article>
                <h1>Film Trust (by Goldbeck)</h1>
                <p>I don't even know why this page exists. Seriously. This site is too simple for a 404. <br />Oh well. It's here. You're here. Guess the page has served its purpose. <br />:/</p>
